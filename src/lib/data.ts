...
export type Rank = 'REC' | 'PTE' | 'LCP' | 'CPL' | 'CFC' | 'SGT' | 'SSG' | 'MSG' | 'LTA' | 'CPT';
...
export const commanders: Commander[] = [
  ...
  { id: 'armymedicalservices', name: 'Nurul Huda', rank: 'CPT', vocation: 'Army Medical Services' },
  { id: 'commandos', name: 'Alex Tan', rank: 'MSG', vocation: 'Commandos' },
  { id: 'guards', name: 'Benjamin Neo', rank: 'LTA', vocation: 'Guards' },
  { id: 'infantry', name: 'Lee Wei', rank: 'CPT', vocation: 'Infantry' },
  { id: 'maintenanceengineeringsupport', name: 'Kenji Tanaka', rank: 'MSG', vocation: 'Maintenance & Engineering Support' },
  { id: 'perscom', name: 'Brenda Lim', rank: 'CPT', vocation: 'PERSCOM (Personnel Command)' },
  { id: 'safammunitioncommand', name: 'Ismail bin Yaacob', rank: 'SSG', vocation: 'SAF Ammunition Command' },
  ...
  { id: 'signals', name: 'Kumar Govindasamy', rank: 'LTA', vocation: 'Signals' },
  { id: 'singaporeartillery', name: 'Daniel Lim', rank: 'CPT', vocation: 'Singapore Artillery' },
  { id: 'combatengineers', name: 'Azman bin Othman', rank: 'MSG', vocation: 'Singapore Combat Engineers' },
  { id: 'supply', name: 'Siti Fatimah', rank: 'SSG', vocation: 'Supply' },
  { id: 'transport', name: 'Michael Wan', rank: 'LTA', vocation: 'Transport' },
];

export const soldiers: Soldier[] = [
  { id: 'armour', name: 'Tan Ah Kow', rank: 'CPL', vocation: 'Armour', commanderId: 'armour', lastLogin: '2023-10-26T10:00:00Z' },
  ...
  { id: 'armyintelligence', name: 'Farah Quinn', rank: 'LCP', vocation: 'Army Intelligence', commanderId: 'armyintelligence', lastLogin: '2023-10-27T08:00:00Z' },
  { id: 'armymedicalservices', name: 'Gopal s/o Kumar', rank: 'REC', vocation: 'Army Medical Services', commanderId: 'armymedicalservices', lastLogin: '2023-10-27T09:00:00Z' },
  { id: 'armymedicalservices', name: 'Cheryl Tan', rank: 'CPL', vocation: 'Army Medical Services', commanderId: 'armymedicalservices', lastLogin: '2023-10-27T09:15:00Z' },
  { id: 'commandos', name: 'Siti Binte Ahmad', rank: 'LCP', vocation: 'Commandos', commanderId: 'commandos', lastLogin: '2023-10-27T11:30:00Z' },
  ...
  { id: 'infantry', name: 'Ken Masters', rank: 'PTE', vocation: 'Infantry', commanderId: 'infantry', lastLogin: '2023-10-27T10:30:00Z' },
  ...
  { id: 'maintenanceengineeringsupport', name: 'Samantha Tay', rank: 'LCP', vocation: 'Maintenance & Engineering Support', commanderId: 'maintenanceengineeringsupport', lastLogin: '2023-10-27T11:00:00Z' },
  { id: 'perscom', name: 'Chun-Li Zhang', rank: 'CPL', vocation: 'PERSCOM (Personnel Command)', commanderId: 'perscom', lastLogin: '2023-10-26T10:00:00Z' },
  { id: 'perscom', name: 'Daniel Yong', rank: 'REC', vocation: 'PERSCOM (Personnel Command)', commanderId: 'perscom', lastLogin: null },
  { id: 'safammunitioncommand', name: 'M. Bison', rank: 'PTE', vocation: 'SAF Ammunition Command', commanderId: 'safammunitioncommand', lastLogin: null },
  ...
  { id: 'safmilitarypolicecommand', name: 'Sagat Petchyindee', rank: 'LCP', vocation: 'SAF Military Police Command', commanderId: 'safmilitarypolicecommand', lastLogin: '2023-10-27T10:00:00Z' },
  ...
  { id: 'signals', name: 'Balrog Johnson', rank: 'PTE', vocation: 'Signals', commanderId: 'signals', lastLogin: '2023-10-27T12:00:00Z' },
  { id: 'signals', name: 'Leon Lai', rank: 'PTE', vocation: 'Signals', commanderId: 'signals', lastLogin: '2023-10-27T12:05:00Z' },
  { id: 'singaporeartillery', name: 'Dhalsim', rank: 'CPL', vocation: 'Singapore Artillery', commanderId: 'singaporeartillery', lastLogin: null },
  ...
  { id: 'combatengineers', name: 'Zangief', rank: 'CFC', vocation: 'Singapore Combat Engineers', commanderId: 'combatengineers', lastLogin: '2023-10-27T10:00:00Z' },
  ...
  { id: 'supply', name: 'Guile', rank: 'PTE', vocation: 'Supply', commanderId: 'supply', lastLogin: '2023-10-27T10:30:00Z' },
  { id: 'supply', name: 'Chow Yun Fat', rank: 'PTE', vocation: 'Supply', commanderId: 'supply', lastLogin: '2023-10-27T10:35:00Z' },
  { id: 'transport', name: 'E. Honda', rank: 'LCP', vocation: 'Transport', commanderId: 'transport', lastLogin: null },
